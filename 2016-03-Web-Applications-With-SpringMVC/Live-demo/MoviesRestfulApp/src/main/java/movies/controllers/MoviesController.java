...
public class MoviesController {
	...
	public List<Movie> getAll(Integer page, String pattern) throws Exception {
		...
		return this.movies.stream().filter(movie -> movie.getTitle().toLowerCase().contains(thePattern))
